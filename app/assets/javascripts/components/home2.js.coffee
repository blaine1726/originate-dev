...
@Home2 = React.createClass
  ...
  componentDidMount: ->
    ...
    @state.line = line
    @state.lineAnimate = TweenLite.to(line, .3, {width: "75%", delay: 0.5, paused: yes}, ease:Power2.easeOut)
