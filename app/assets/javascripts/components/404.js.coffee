  ...
  render: ->
    ...
    div
      ...
      svg
        ...
        viewBox: "0 0 612 240"
        style:
          enableBackground: "new 0 0 612 240"
        xml:space: "preserve"
        g
          g
            path
              className: 'obj-1'
              d: "M62.9,193.6c-13.7,0-27.5,0-41.2,0c-1.7,0-3.5,0.2-5.2,0.3c-2,0.2-2.7-0.8-2.7-2.7c0-7.8,0-15.7,0-23.5c0-3,0-6,0-9
        ...
        g
          g
            path
              className: 'obj-2'
              d: "M491.9,194.1c-13.7,0-27.5,0-41.2,0c-1.7,0-3.5,0.2-5.2,0.3c-2,0.2-2.7-0.8-2.7-2.7c0-7.8,0-15.7,0-23.5c0-3,0-6,0-9
            			c0-2.2,0.2-4.3,1.9-6.2c1.7-2,2.1-4.9,2.9-7.3c1-3.4,2.5-6.6,3.6-10.1c1-3.2,2-6.5,3.6-9.5c0.2-0.4,0.6-0.9,0.6-1.4
            			c0.2-3.9,2.3-7.2,3.6-10.7c2-5.4,4-10.8,6-16.2c1.2-3.2,2.5-6.4,3.5-9.7c1.2-3.7,2.4-7.5,4-11.1c1.4-3.2,2.3-6.7,3.6-10
            			c1.4-3.4,2.2-6.9,3.8-10.2c1.4-2.9,2.1-6.1,3.3-9.1c2.4-6.3,4.7-12.7,6.9-19c1.1-3.2,2.4-6.4,3.4-9.6c1-3,2.5-5.8,3-9
        ...
        g
          g
            path
              className: 'obj-3'
              d: "M303.5,1.5c35.8-0.8,65.9,11.4,90.2,37c14,14.8,22.2,32.9,26.2,52.7c5.7,28,4,55.6-7.8,81.7
      ...
      div className: 'error-text',
        div className: 'error-title', "OOPS!"
        div className: 'error-subtitle', "Didn't mean for that to happen."
        div className: 'error-subtext', 'Go ahead and play with some birds in the meantime.'
